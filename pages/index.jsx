...
<head>
    ...
    <title>Absolute Cinema - Home Page</title>z
</head>
...
<body class="bg-black">
    ...
    <div class="banner text-white p-5" style="background-image: url(../assets/backgrounds/banner.jpg)">
        <div class="p-5">
            ...
            <a href="moviesPage.php" class="btn btn-danger">Browse Movies</a>
        </div>
    </div>
    ...
    <div class="text-white p-4">
        <span class="d-flex flex-row justify-content-between">
            ...
            <a href="moviesPage.php" class="text-danger fs-5">View All →</a>
        </span>
    </div>
